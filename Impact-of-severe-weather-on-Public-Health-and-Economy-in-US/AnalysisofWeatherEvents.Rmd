...
grid.arrange(p1, p2, top="Analysis of deadly weather events in the US (1950-2011) wrt Population's Health")
...
grid.arrange(p3, p4, top="Analysis of deadly weather events in the US (1950-2011) wrt population's Economy")

```

This concludes the analysis to find the effects of these severe weather conditions in US.